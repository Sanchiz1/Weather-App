                            ...
                            <Col className='mb-3'>
                                <Row>
                                    <Col className='d-flex justify-content-end'>
                                        <div className='w-75'><WeatherIcon id={weather.days[0].day[hour]?.weather[0].icon}></WeatherIcon></div>
                                    </Col>
                                    <Col className='d-flex justify-content-start flex-column p-0'>
                                        <h2 className='m-0'>{Math.round(weather.days[0].day[hour]?.main.temp)}{'\u00b0'}</h2>
