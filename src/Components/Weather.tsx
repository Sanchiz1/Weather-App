...
function Weather() {
    ...
    time.setHours(time.getHours() + city?.timezone / 3600 + time.getTimezoneOffset() / 60);
                            ...
                            <Col className='mb-3'>
                                <Row>
                                    <Col className='d-flex justify-content-end'>
                                        <div className='w-75'><WeatherIcon id={weather.days[0].day[0]?.weather[0].icon}></WeatherIcon></div>
                                    </Col>
                                    <Col className='d-flex justify-content-start flex-column p-0'>
                                        <h2 className='m-0'>{Math.round(weather.days[0].day[0]?.main.temp)}{'\u00b0'}</h2>
                                        <h5 className='m-0'>{weather.days[0].day[0]?.weather[0].description}</h5>
                                    </Col>
                                </Row>
                            </Col>
                            <Col className='d-flex flex-column text-end'>
                                <h5 className='m-0'>Wind: {weather.days[0].day[0]?.wind.speed} m/s</h5>
                                <h5 className='m-0'>Humidity: {weather.days[0].day[0]?.main.humidity}%</h5>
                                <h5 className='m-0'>Clouds: {weather.days[0].day[0]?.clouds.all}%</h5>
                            </Col>
